...
Diarization works best if you have [a HuggingFace Access Token](https://huggingface.co/settings/tokens) which makes it easy to download the most up-to-date models. You can also leave it blank, like in the example here, but the results are not guaranteed.
